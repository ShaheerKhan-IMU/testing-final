...
"[project]/app/components/predictionchart.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PredictedSalesChart() {
    ...
    const [chartData, setChartData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PredictedSalesChart.useEffect": ()=>{
            fetch("http://127.0.0.1:8000/data").then({
                "PredictedSalesChart.useEffect": (res)=>res.json()
            }["PredictedSalesChart.useEffect"]).then({
                "PredictedSalesChart.useEffect": (data)=>{
                    const labels = [
    ...
    if (!chartData) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        children: "Loading chart..."
    }, void 0, false, {
...
_s(PredictedSalesChart, "9euvDhZ+n6eLTlbzwvHmNPhoqAw=");
_c = PredictedSalesChart;
var _c;
__turbopack_context__.k.register(_c, "PredictedSalesChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=app_components_9c807328._.js.map